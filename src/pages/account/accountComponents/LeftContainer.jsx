...
const LeftContainer = ({ user, handleImageChange, handlePasswordOpen, handlePersonalOpen, handlePostsOpen, isMobile, isTablet }) => {
    return (
        <>
            {isMobile ? (
                    ...
                    <div className="left__content-mobile">
                        <div className="left__header">
                            ...
                            <input
                                ...
                                style={{ display: 'none' }}
                            />
                            <div className="left__name_email-mobile">
                ...
                <div className="left__container-tablet">
                    <div className="left__content-tablet">
                        <div className="left__header">
                            <label htmlFor="profile-picture-input">
                                <img src={user.photoURL || 'fallback_image_url'} alt={user.displayName} />
                                <div className="change-picture-btn">
